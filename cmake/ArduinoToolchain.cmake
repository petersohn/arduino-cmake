...
if (EXISTS ${CMAKE_CURRENT_LIST_DIR}/Tools/reset.py)
  set(RESET_PROGRAM "python")
  set(RESET_SCRIPT "${CMAKE_CURRENT_LIST_DIR}/Tools/reset.py")
endif ()
...
if (NOT ARDUINO_HARDWARE_PATH)
  set(ARDUINO_HARDWARE_PATH ${ARDUINO_SDK_PATH}/hardware)
endif ()

if (NOT EXISTS ${ARDUINO_HARDWARE_PATH})
  message(FATAL_ERROR "Arduino hardware path (ARDUINO_HARDWARE_PATH) \"${ARDUINO_HARDWARE_PATH}\" dose not exist!")
endif ()

if (NOT ARDUINO_HARDWARE_VENDOR)
